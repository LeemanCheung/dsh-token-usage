...
export const zh = {
  ...
  analysisPrivacy: '隐私：手动选择的模型只接收白名单元数据和 provider 上报 Token；不发送提示词、回复、工具名称/参数/结果、会话标题或个人与组织字段。',
  analysis: '轨迹分析',
  analyze: '分析轨迹',
  analyzing: '分析中…',
  loading: '正在读取会话统计…',
...
export const en = {
  ...
  analysisPrivacy: 'Privacy: the manually selected model receives only allowlisted metadata and provider-reported Token buckets—never prompts, replies, tool names/arguments/results, session titles, or personal and organization fields.',
