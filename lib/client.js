window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function periodInsight(records, days, now = Date.now()) {
			...
			})).filter((record) => totalTokens$2(record.usage) > 0);
			const peak = active.reduce((highest, record) => highest === void 0 || totalTokens$2(record.usage) > totalTokens$2(highest.usage) ? record : highest, void 0);
			return {
				days,
		...
		function dailyContributors(sessions, date) {
			return sessions.flatMap((session) => {
				...
				if (record === void 0 || totalTokens$2(record.usage) === 0) return [];
				return [{
					id: session.id,
					title: session.title,
					usage: { ...record.usage }
				}];
			}).sort((left, right) => totalTokens$2(right.usage) - totalTokens$2(left.usage) || left.title.localeCompare(right.title) || left.id.localeCompare(right.id));
		}
		//#endregion
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", { children: t("modelBreakdown") }), data.models.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("table", {
								...
								] }) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tbody", { children: costSummary.models.map((model) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [
