window.__ModuleLoader__.load({
	...
	factory: (require) => {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Metric, {
								...
								value: metrics.toolCalls - metrics.orphanToolCalls <= 0 ? "—" : `${formatLatency(metrics.averageToolLatencyMs)} / ${formatLatency(metrics.maxToolLatencyMs)}`
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Metric, {
		...
		function metricsOf(value) {
			...
			if (!baseNumericKeys.every((key) => validNumber(value[key]))) return void 0;
			if (!extendedNumericKeys.every((key) => value[key] === void 0 || validNumber(value[key]))) return void 0;
