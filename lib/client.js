window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function spanOf(value) {
			if (!isRecord$1(value) || typeof value.id !== "string" || value.kind !== "model" && value.kind !== "compaction" || typeof value.seq !== "number" || !Number.isSafeInteger(value.seq) || typeof value.provider !== "string" || typeof value.model !== "string" || ![
				"open",
				"completed",
				"retried"
