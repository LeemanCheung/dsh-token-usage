	...
	factory: (require) => {
		...
		*/
		...
		var TokenUsageSection_module_css_default = {
			...
			"routeBudgetRow": "hGAOSW_routeBudgetRow",
			"activityCell": "hGAOSW_activityCell",
			"analysisLoading": "hGAOSW_analysisLoading",
			...
			"historyDeleteButton": "hGAOSW_historyDeleteButton",
			"analysisPrivacy": "hGAOSW_analysisPrivacy",
			"metrics": "hGAOSW_metrics",
			"budget": "hGAOSW_budget",
			"analysisSummaryGroup": "hGAOSW_analysisSummaryGroup",
			"analysisScope": "hGAOSW_analysisScope",
			"blockHead": "hGAOSW_blockHead",
			"routeBudgetHead": "hGAOSW_routeBudgetHead",
			"insightNote": "hGAOSW_insightNote",
			"conversationAnalysisButton": "hGAOSW_conversationAnalysisButton",
			"analysisProgressMeta": "hGAOSW_analysisProgressMeta",
			"contributors": "hGAOSW_contributors",
			"analysisSpinner": "hGAOSW_analysisSpinner",
			"priceValue": "hGAOSW_priceValue",
			"rangeTabs": "hGAOSW_rangeTabs",
			"budgetProgress": "hGAOSW_budgetProgress",
			"section": "hGAOSW_section",
			"analysisSummaryGrid": "hGAOSW_analysisSummaryGrid",
			"modelTable": "hGAOSW_modelTable",
			"insights": "hGAOSW_insights",
			"conversationAnalysisControls": "hGAOSW_conversationAnalysisControls",
			"analysisHeaderActions": "hGAOSW_analysisHeaderActions",
			"activity": "hGAOSW_activity",
			"analysisEmpty": "hGAOSW_analysisEmpty",
			"quietButton": "hGAOSW_quietButton",
			"analysisLoadingBody": "hGAOSW_analysisLoadingBody",
			"exportControls": "hGAOSW_exportControls",
			"routeBudgetUsage": "hGAOSW_routeBudgetUsage",
			"routeBudgetList": "hGAOSW_routeBudgetList",
			...
			"routeBudgetIdentity": "hGAOSW_routeBudgetIdentity",
			"sessionTable": "hGAOSW_sessionTable",
			"analysisDialogContent": "hGAOSW_analysisDialogContent",
			"priceUnknown": "hGAOSW_priceUnknown",
			"analysisWarning": "hGAOSW_analysisWarning",
			"status": "hGAOSW_status",
			"routeBudgets": "hGAOSW_routeBudgets",
			"routeBudgetStatus": "hGAOSW_routeBudgetStatus",
			"analysisHistory": "hGAOSW_analysisHistory",
			"analysisError": "hGAOSW_analysisError",
			"routeBudgetEditor": "hGAOSW_routeBudgetEditor",
			"analysisDialog": "hGAOSW_analysisDialog",
			"token-analysis-spin": "hGAOSW_token-analysis-spin",
			"cacheDetail": "hGAOSW_cacheDetail",
			"metric": "hGAOSW_metric",
			"activityHead": "hGAOSW_activityHead",
			"trendControls": "hGAOSW_trendControls",
