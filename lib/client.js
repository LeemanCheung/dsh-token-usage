window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$1 = ".QxFMzq_section{width:100%;max-width:960px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:22px;display:flex}.QxFMzq_header{justify-content:space-between;align-items:flex-start;gap:16px;display:flex}.QxFMzq_header h2,.QxFMzq_header p,.QxFMzq_block h3,.QxFMzq_status{margin:0}.QxFMzq_header h2{font-size:18px;font-weight:600;line-height:26px}.QxFMzq_header p{max-width:720px;color:var(--dsw-alias-label-tertiary);margin-top:5px;font-size:13px;line-height:20px}.QxFMzq_metrics{grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;display:grid}.QxFMzq_metric{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:7px;min-width:0;padding:13px 14px;display:flex}.QxFMzq_metric span{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:16px;overflow:hidden}.QxFMzq_metric strong{font-variant-numeric:tabular-nums;text-overflow:ellipsis;font-size:20px;line-height:26px;overflow:hidden}.QxFMzq_activity{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:10px;min-width:0;padding:14px;display:flex}.QxFMzq_activityHead{justify-content:space-between;align-items:flex-end;gap:14px;display:flex}.QxFMzq_activityHead h3,.QxFMzq_activityHead p{margin:0}.QxFMzq_activityHead h3{font-size:14px;font-weight:600;line-height:22px}.QxFMzq_activityHead p{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:11px;line-height:17px}.QxFMzq_activityGrid{box-sizing:border-box;grid-template-rows:repeat(7,minmax(0,1fr));grid-template-columns:repeat(30,minmax(0,1fr));grid-auto-flow:column;gap:3px;width:100%;min-width:0;padding:2px;display:grid}.QxFMzq_activityCell,.QxFMzq_activityLegend i{background:var(--dsw-alias-bg-module-platform);border:0;border-radius:2px;flex:none;display:block}.QxFMzq_activityCell{aspect-ratio:1;cursor:pointer;width:100%;min-width:0;padding:0}.QxFMzq_activityCell:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.QxFMzq_activityCell[data-selected=true]{box-shadow:0 0 0 2px var(--dsw-alias-label-primary)}.QxFMzq_activityLegend i{width:10px;height:10px}.QxFMzq_activityCell[data-future=true]{cursor:default;background:0 0}.QxFMzq_activityCell[data-level=\"1\"],.QxFMzq_activityLegend i[data-level=\"1\"]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 22%, var(--dsw-alias-bg-module-platform))}.QxFMzq_activityCell[data-level=\"2\"],.QxFMzq_activityLegend i[data-level=\"2\"]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 42%, var(--dsw-alias-bg-module-platform))}.QxFMzq_activityCell[data-level=\"3\"],.QxFMzq_activityLegend i[data-level=\"3\"]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 64%, var(--dsw-alias-bg-module-platform))}.QxFMzq_activityCell[data-level=\"4\"],.QxFMzq_activityLegend i[data-level=\"4\"]{background:var(--dsw-alias-state-business-primary)}.QxFMzq_activityLegend{color:var(--dsw-alias-label-tertiary);white-space:nowrap;align-items:center;gap:4px;font-size:10px;line-height:14px;display:flex}.QxFMzq_insights,.QxFMzq_budget,.QxFMzq_dayDrilldown{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:12px;min-width:0;padding:14px;display:flex}.QxFMzq_insights h3,.QxFMzq_budget h3,.QxFMzq_dayDrilldown h3,.QxFMzq_insights p,.QxFMzq_budget p,.QxFMzq_dayDrilldown p{margin:0}.QxFMzq_insights h3,.QxFMzq_budget h3,.QxFMzq_dayDrilldown h3{font-size:14px;font-weight:600;line-height:22px}.QxFMzq_insights .QxFMzq_blockHead p,.QxFMzq_budget .QxFMzq_blockHead p,.QxFMzq_dayDrilldown .QxFMzq_blockHead p{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:11px;line-height:17px}.QxFMzq_detailMetrics{grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;display:grid}.QxFMzq_trendControls,.QxFMzq_rangeTabs,.QxFMzq_exportControls{flex-wrap:wrap;align-items:center;gap:6px;display:flex}.QxFMzq_trendControls{justify-content:flex-end}.QxFMzq_rangeTabs button,.QxFMzq_exportControls button,.QxFMzq_quietButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:30px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:7px;padding:0 9px;font-size:11px}.QxFMzq_rangeTabs button[aria-pressed=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, var(--dsw-alias-bg-layer-1));color:var(--dsw-alias-state-business-primary)}.QxFMzq_rangeTabs button:focus-visible,.QxFMzq_exportControls button:focus-visible,.QxFMzq_quietButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.QxFMzq_exportControls{justify-content:flex-end}.QxFMzq_exportControls>span{color:var(--dsw-alias-label-tertiary);font-size:11px}.QxFMzq_exportControls>small{max-width:520px;color:var(--dsw-alias-label-tertiary);text-align:right;flex-basis:100%;font-size:10px;line-height:15px}.QxFMzq_exportControls button:disabled,.QxFMzq_quietButton:disabled{opacity:.5;cursor:not-allowed}.QxFMzq_insightNote{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.QxFMzq_anomalyNotice{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:10px;font-size:11px;line-height:17px;display:flex}.QxFMzq_anomalyNotice p{margin:0}.QxFMzq_budgetInput{color:var(--dsw-alias-label-tertiary);white-space:nowrap;align-items:center;gap:7px;font-size:11px;display:flex}.QxFMzq_budgetInput input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:128px;height:30px;color:var(--dsw-alias-label-primary);font:inherit;font-variant-numeric:tabular-nums;border-radius:7px;outline:none;padding:0 8px;font-size:12px}.QxFMzq_budgetInput input:focus-visible{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}.QxFMzq_budgetProgress{align-items:center;gap:10px;display:flex}.QxFMzq_budgetProgress progress{width:min(320px,55%);height:8px;accent-color:var(--dsw-alias-state-business-primary)}.QxFMzq_budgetProgress strong{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;font-size:12px}.QxFMzq_budgetWarning{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.QxFMzq_routeBudgets{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:10px;padding-top:12px;display:flex}.QxFMzq_routeBudgetHead{justify-content:space-between;align-items:flex-end;gap:14px;display:flex}.QxFMzq_routeBudgetHead h4,.QxFMzq_routeBudgetHead p{margin:0}.QxFMzq_routeBudgetHead h4{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.QxFMzq_routeBudgetHead p{max-width:560px;color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:11px;line-height:17px}.QxFMzq_routeBudgetEditor{grid-template-columns:minmax(160px,1fr) 132px auto;align-items:end;gap:7px;display:grid}.QxFMzq_routeBudgetEditor label{min-width:0;color:var(--dsw-alias-label-tertiary);flex-direction:column;gap:3px;font-size:10px;display:flex}.QxFMzq_routeBudgetEditor select,.QxFMzq_routeBudgetEditor input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-primary);font:inherit;border-radius:7px;padding:0 8px;font-size:11px}.QxFMzq_routeBudgetEditor select:focus-visible,.QxFMzq_routeBudgetEditor input:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.QxFMzq_routeBudgetList{flex-direction:column;display:flex}.QxFMzq_routeBudgetRow{border-top:1px solid var(--dsw-alias-border-l2);grid-template-columns:minmax(170px,.8fr) minmax(260px,1.6fr) auto;align-items:center;gap:12px;padding:10px 0;display:grid}.QxFMzq_routeBudgetRow:last-child{padding-bottom:0}.QxFMzq_routeBudgetIdentity{flex-direction:column;gap:2px;min-width:0;display:flex}.QxFMzq_routeBudgetIdentity>strong{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;overflow:hidden}.QxFMzq_routeBudgetStatus{color:var(--dsw-alias-label-secondary);font-size:10px;font-weight:600;line-height:15px}.QxFMzq_routeBudgetStatus[data-status=warning],.QxFMzq_routeBudgetStatus[data-status=forecast-exceeded]{color:var(--dsw-alias-state-business-primary)}.QxFMzq_routeBudgetStatus[data-status=exceeded]{color:var(--dsw-alias-state-error-primary)}.QxFMzq_routeBudgetStatus[data-status=unavailable]{color:var(--dsw-alias-label-tertiary)}.QxFMzq_routeBudgetUsage{flex-direction:column;gap:3px;min-width:0;display:flex}.QxFMzq_routeBudgetRow>.QxFMzq_quietButton{justify-self:end}.QxFMzq_contributors{flex-direction:column;gap:7px;display:flex}.QxFMzq_contributors>strong{color:var(--dsw-alias-label-secondary);font-size:12px}.QxFMzq_contributors ol{gap:5px;margin:0;padding:0;list-style:none;display:grid}.QxFMzq_contributors li{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:7px;justify-content:space-between;align-items:center;gap:12px;padding:7px 9px;font-size:12px;display:flex}.QxFMzq_contributors li>span{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.QxFMzq_block{flex-direction:column;gap:10px;min-width:0;display:flex}.QxFMzq_block h3{font-size:14px;font-weight:600;line-height:22px}.QxFMzq_blockHead{justify-content:space-between;align-items:center;gap:16px;display:flex}.QxFMzq_blockHead input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:min(280px,45%);height:34px;color:var(--dsw-alias-label-primary);font:inherit;border-radius:8px;outline:none;padding:0 11px;font-size:12px}.QxFMzq_blockHead input::placeholder{color:var(--dsw-alias-label-tertiary)}.QxFMzq_blockHead input:focus-visible{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}.QxFMzq_tableWrap{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;min-width:0;overflow:auto}.QxFMzq_tableWrap table{border-collapse:collapse;width:100%;min-width:0;font-size:12px;line-height:18px}.QxFMzq_tableWrap .QxFMzq_modelTable{table-layout:fixed;min-width:580px}.QxFMzq_tableWrap .QxFMzq_sessionTable{min-width:780px}.QxFMzq_modelTable th:first-child,.QxFMzq_modelTable td:first-child{width:30%}.QxFMzq_modelTable th:nth-child(2),.QxFMzq_modelTable td:nth-child(2){width:18%}.QxFMzq_tableWrap th,.QxFMzq_tableWrap td{border-bottom:1px solid var(--dsw-alias-border-l1);text-align:right;vertical-align:middle;white-space:nowrap;padding:10px 12px}.QxFMzq_tableWrap th{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-tertiary);font-size:11px;font-weight:500}.QxFMzq_tableWrap th:first-child,.QxFMzq_tableWrap td:first-child{text-align:left;max-width:270px}.QxFMzq_tableWrap tbody tr:last-child td{border-bottom:0}.QxFMzq_tableWrap tbody tr:hover td{background:var(--dsw-alias-interactive-bg-hover)}.QxFMzq_tableWrap td{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums}.QxFMzq_tableWrap td strong,.QxFMzq_tableWrap td span{text-overflow:ellipsis;max-width:260px;display:block;overflow:hidden}.QxFMzq_tableWrap td strong{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600}.QxFMzq_tableWrap td span{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.QxFMzq_tableWrap td .QxFMzq_tokenValue{max-width:none;color:inherit;font-size:inherit;line-height:inherit;display:inline}.QxFMzq_tableWrap td .QxFMzq_cacheDetail{margin-top:2px}.QxFMzq_analysisEmpty,.QxFMzq_analysisError,.QxFMzq_analysisPanel{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:12px;min-width:0;padding:14px;display:flex}.QxFMzq_analysisEmpty{border-style:dashed}.QxFMzq_analysisError{border-color:var(--dsw-alias-state-error-primary)}.QxFMzq_analysisEmpty h3,.QxFMzq_analysisEmpty p,.QxFMzq_analysisError h3,.QxFMzq_analysisError p,.QxFMzq_analysisPanel h3,.QxFMzq_analysisPanel p{margin:0}.QxFMzq_analysisEmpty h3,.QxFMzq_analysisError h3,.QxFMzq_analysisPanel h3{font-size:14px;font-weight:600;line-height:22px}.QxFMzq_analysisEmpty p,.QxFMzq_analysisError p,.QxFMzq_analysisPanel .QxFMzq_blockHead p,.QxFMzq_analysisPrivacy{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:18px}.QxFMzq_analysisError p,.QxFMzq_analysisWarning{color:var(--dsw-alias-state-error-primary)}.QxFMzq_analysisCost{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:999px;padding:5px 9px;font-size:11px}.QxFMzq_analysisReport{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-module-platform);max-height:640px;color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere;border-radius:10px;margin:0;padding:18px 20px;font-size:13px;line-height:1.75;overflow:auto}.QxFMzq_analysisReport h1,.QxFMzq_analysisReport h2,.QxFMzq_analysisReport h3,.QxFMzq_analysisReport h4{color:var(--dsw-alias-label-primary);margin:1.25em 0 .55em;line-height:1.35}.QxFMzq_analysisReport h1:first-child,.QxFMzq_analysisReport h2:first-child,.QxFMzq_analysisReport h3:first-child,.QxFMzq_analysisReport p:first-child{margin-top:0}.QxFMzq_analysisReport p,.QxFMzq_analysisReport ul,.QxFMzq_analysisReport ol,.QxFMzq_analysisReport blockquote,.QxFMzq_analysisReport table{margin:.65em 0}.QxFMzq_analysisReport blockquote{border-left:3px solid var(--dsw-alias-state-business-primary);color:var(--dsw-alias-label-tertiary);padding-left:12px}.QxFMzq_analysisReport table{border-collapse:collapse;width:100%;font-size:12px}.QxFMzq_analysisReport th,.QxFMzq_analysisReport td{border:1px solid var(--dsw-alias-border-l2);text-align:left;vertical-align:top;padding:7px 9px}.QxFMzq_analysisReport th{background:var(--dsw-alias-bg-layer-3);color:var(--dsw-alias-label-primary)}.QxFMzq_analysisReport code{background:var(--dsw-alias-bg-layer-3);border-radius:4px;padding:1px 4px;font-family:ui-monospace,SFMono-Regular,Consolas,monospace;font-size:.92em}.QxFMzq_analysisHeaderActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;display:flex}.QxFMzq_analysisSummaryGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:9px;display:grid}.QxFMzq_analysisSummaryGroup{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);border-radius:9px;min-width:0;padding:10px 12px}.QxFMzq_analysisSummaryGroup h4{color:var(--dsw-alias-label-primary);margin:0 0 6px;font-size:12px;line-height:18px}.QxFMzq_analysisSummaryGroup dl{gap:4px;margin:0;display:grid}.QxFMzq_analysisSummaryGroup dl>div{justify-content:space-between;align-items:baseline;gap:10px;display:flex}.QxFMzq_analysisSummaryGroup dt{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;overflow:hidden}.QxFMzq_analysisSummaryGroup dd{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;white-space:nowrap;margin:0;font-size:12px;font-weight:600}.QxFMzq_analysisLoading{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;align-items:flex-start;gap:12px;padding:14px;display:flex}.QxFMzq_analysisSpinner{border:2px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:18px;height:18px;margin-top:2px;animation:.85s linear infinite QxFMzq_token-analysis-spin}.QxFMzq_analysisLoadingBody{flex:1;gap:6px;min-width:0;display:grid}.QxFMzq_analysisLoadingBody h3,.QxFMzq_analysisLoadingBody p{margin:0}.QxFMzq_analysisLoadingBody h3{color:var(--dsw-alias-label-primary);font-size:14px}.QxFMzq_analysisLoadingBody p,.QxFMzq_analysisProgressMeta{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.QxFMzq_analysisProgressMeta{flex-wrap:wrap;gap:10px;display:flex}.QxFMzq_analysisProgressMeta strong{color:var(--dsw-alias-state-business-primary)}.QxFMzq_analysisLoadingBody progress{width:100%;height:7px;accent-color:var(--dsw-alias-state-business-primary)}@keyframes QxFMzq_token-analysis-spin{to{transform:rotate(360deg)}}.QxFMzq_analysisWarning{font-size:11px;line-height:18px}.QxFMzq_modelSort{color:var(--dsw-alias-label-tertiary);align-items:center;gap:6px;font-size:11px;display:flex}.QxFMzq_modelSort select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:116px;color:var(--dsw-alias-label-primary);font:inherit;border-radius:7px;padding:5px 7px;font-size:12px}.QxFMzq_modelSort select:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.QxFMzq_sessionLink{max-width:240px;color:var(--dsw-alias-label-primary);font:inherit;text-align:left;text-overflow:ellipsis;white-space:nowrap;cursor:pointer;background:0 0;border:0;padding:0;font-weight:600;text-decoration:underline #0000;display:block;overflow:hidden}.QxFMzq_sessionLink:hover{text-decoration-color:currentColor}.QxFMzq_sessionLink:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;border-radius:2px}.QxFMzq_analysisButton{border:1px solid var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, var(--dsw-alias-bg-layer-1));min-height:28px;color:var(--dsw-alias-state-business-primary);font:inherit;cursor:pointer;border-radius:7px;padding:0 9px;font-size:11px}.QxFMzq_analysisButton:disabled{cursor:wait;opacity:.65}.QxFMzq_analysisButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.QxFMzq_pricingNotice{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3);color:var(--dsw-alias-label-tertiary);border-radius:10px;align-items:baseline;gap:8px;padding:10px 12px;font-size:11px;line-height:18px;display:flex}.QxFMzq_pricingNotice strong{color:var(--dsw-alias-label-secondary);white-space:nowrap;font-weight:600}.QxFMzq_pricingNotice p{margin:0}.QxFMzq_priceUnknown{color:var(--dsw-alias-label-tertiary)}.QxFMzq_priceValue{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;white-space:nowrap}.QxFMzq_analysisModelSelect{min-width:180px;color:var(--dsw-alias-label-tertiary);gap:4px;font-size:11px;line-height:16px;display:grid}.QxFMzq_analysisModelSelect select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:0;color:var(--dsw-alias-label-primary);font:inherit;border-radius:7px;padding:5px 7px;font-size:12px}.QxFMzq_analysisModelSelect select:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.QxFMzq_analysisScope{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:18px}.QxFMzq_analysisErrorText{color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:18px}.QxFMzq_conversationAnalysisButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);height:28px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:7px;padding:0 9px;font-size:11px}.QxFMzq_conversationAnalysisButton:hover{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.QxFMzq_conversationAnalysisButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.QxFMzq_analysisDialog{width:min(820px,100%);max-height:min(84dvh,780px)}.QxFMzq_analysisDialogContent{overscroll-behavior:contain;min-height:0;overflow-y:auto}.QxFMzq_analysisDialog .QxFMzq_analysisReport{max-height:min(48dvh,460px)}.QxFMzq_conversationAnalysisControls{flex-wrap:wrap;align-items:end;gap:10px;margin-bottom:12px;display:flex}.QxFMzq_analysisHistory{border-top:1px solid var(--dsw-alias-border-l1);gap:9px;margin-top:16px;padding-top:14px;display:grid}.QxFMzq_analysisHistory h3,.QxFMzq_analysisHistory p{margin:0}.QxFMzq_analysisHistory .QxFMzq_blockHead>span{color:var(--dsw-alias-label-tertiary);font-size:11px}.QxFMzq_analysisHistory ul{gap:6px;max-height:210px;margin:0;padding:0;list-style:none;display:grid;overflow:auto}.QxFMzq_analysisHistory li{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);border-radius:8px;align-items:stretch;display:flex}.QxFMzq_analysisHistory li>button:first-child{min-width:0;color:var(--dsw-alias-label-secondary);text-align:left;cursor:pointer;background:0 0;border:0;flex:1;justify-content:space-between;align-items:center;gap:10px;padding:8px 10px;display:flex}.QxFMzq_analysisHistory li>button:first-child:hover{background:var(--dsw-alias-interactive-bg-hover)}.QxFMzq_analysisHistory li strong{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;overflow:hidden}.QxFMzq_analysisHistory li span{color:var(--dsw-alias-label-tertiary);white-space:nowrap;font-size:10px}.QxFMzq_historyDeleteButton{border:0;border-left:1px solid var(--dsw-alias-border-l1);width:34px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;font-size:18px}.QxFMzq_historyDeleteButton:hover{color:var(--dsw-alias-state-error-primary)}.QxFMzq_status{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-tertiary);border-radius:10px;padding:16px;font-size:13px;line-height:20px}@media (prefers-reduced-motion:reduce){.QxFMzq_analysisSpinner{animation:none}}@media (width<=860px){.QxFMzq_metrics{grid-template-columns:repeat(3,minmax(0,1fr))}.QxFMzq_detailMetrics,.QxFMzq_analysisSummaryGrid{grid-template-columns:repeat(2,minmax(0,1fr))}.QxFMzq_routeBudgetHead{flex-direction:column;align-items:stretch}.QxFMzq_routeBudgetRow{grid-template-columns:minmax(160px,.8fr) minmax(240px,1.4fr) auto}}@media (width<=580px){.QxFMzq_metrics,.QxFMzq_detailMetrics{grid-template-columns:repeat(2,minmax(0,1fr))}.QxFMzq_analysisSummaryGrid{grid-template-columns:minmax(0,1fr)}.QxFMzq_header,.QxFMzq_activityHead,.QxFMzq_blockHead{flex-direction:column;align-items:stretch;gap:8px}.QxFMzq_exportControls{justify-content:flex-start}.QxFMzq_exportControls>small{text-align:left}.QxFMzq_routeBudgetEditor,.QxFMzq_routeBudgetRow{grid-template-columns:minmax(0,1fr)}.QxFMzq_routeBudgetRow{gap:8px}.QxFMzq_routeBudgetRow>.QxFMzq_quietButton{justify-self:start}.QxFMzq_budgetInput{justify-content:space-between}.QxFMzq_pricingNotice{flex-direction:column;align-items:flex-start;gap:2px}.QxFMzq_budgetProgress{flex-direction:column;align-items:flex-start}.QxFMzq_budgetProgress progress,.QxFMzq_blockHead input{width:100%}}";
		...
		var TokenUsageSection_module_css_default = {
			"activity": "QxFMzq_activity",
			"activityCell": "QxFMzq_activityCell",
			"activityGrid": "QxFMzq_activityGrid",
			"activityHead": "QxFMzq_activityHead",
			"activityLegend": "QxFMzq_activityLegend",
			"analysisButton": "QxFMzq_analysisButton",
			"analysisCost": "QxFMzq_analysisCost",
			"analysisDialog": "QxFMzq_analysisDialog",
			"analysisDialogContent": "QxFMzq_analysisDialogContent",
			"analysisEmpty": "QxFMzq_analysisEmpty",
			"analysisError": "QxFMzq_analysisError",
			"analysisErrorText": "QxFMzq_analysisErrorText",
			"analysisHeaderActions": "QxFMzq_analysisHeaderActions",
			"analysisHistory": "QxFMzq_analysisHistory",
			"analysisLoading": "QxFMzq_analysisLoading",
			"analysisLoadingBody": "QxFMzq_analysisLoadingBody",
			"analysisModelSelect": "QxFMzq_analysisModelSelect",
			"analysisPanel": "QxFMzq_analysisPanel",
			"analysisPrivacy": "QxFMzq_analysisPrivacy",
			"analysisProgressMeta": "QxFMzq_analysisProgressMeta",
			"analysisReport": "QxFMzq_analysisReport",
			"analysisScope": "QxFMzq_analysisScope",
			"analysisSpinner": "QxFMzq_analysisSpinner",
			"analysisSummaryGrid": "QxFMzq_analysisSummaryGrid",
			"analysisSummaryGroup": "QxFMzq_analysisSummaryGroup",
			"analysisWarning": "QxFMzq_analysisWarning",
			"anomalyNotice": "QxFMzq_anomalyNotice",
			"block": "QxFMzq_block",
			"blockHead": "QxFMzq_blockHead",
			"budget": "QxFMzq_budget",
			"budgetInput": "QxFMzq_budgetInput",
			"budgetProgress": "QxFMzq_budgetProgress",
			"budgetWarning": "QxFMzq_budgetWarning",
			"cacheDetail": "QxFMzq_cacheDetail",
			"contributors": "QxFMzq_contributors",
			"conversationAnalysisButton": "QxFMzq_conversationAnalysisButton",
			"conversationAnalysisControls": "QxFMzq_conversationAnalysisControls",
			"dayDrilldown": "QxFMzq_dayDrilldown",
			"detailMetrics": "QxFMzq_detailMetrics",
			"exportControls": "QxFMzq_exportControls",
			"header": "QxFMzq_header",
			"historyDeleteButton": "QxFMzq_historyDeleteButton",
			"insightNote": "QxFMzq_insightNote",
			"insights": "QxFMzq_insights",
			"metric": "QxFMzq_metric",
			"metrics": "QxFMzq_metrics",
			"modelSort": "QxFMzq_modelSort",
			"modelTable": "QxFMzq_modelTable",
			"priceUnknown": "QxFMzq_priceUnknown",
			"priceValue": "QxFMzq_priceValue",
			"pricingNotice": "QxFMzq_pricingNotice",
			"quietButton": "QxFMzq_quietButton",
			"rangeTabs": "QxFMzq_rangeTabs",
			"routeBudgetEditor": "QxFMzq_routeBudgetEditor",
			"routeBudgetHead": "QxFMzq_routeBudgetHead",
			"routeBudgetIdentity": "QxFMzq_routeBudgetIdentity",
			"routeBudgetList": "QxFMzq_routeBudgetList",
			"routeBudgetRow": "QxFMzq_routeBudgetRow",
			"routeBudgetStatus": "QxFMzq_routeBudgetStatus",
			"routeBudgetUsage": "QxFMzq_routeBudgetUsage",
			"routeBudgets": "QxFMzq_routeBudgets",
			"section": "QxFMzq_section",
			"sessionLink": "QxFMzq_sessionLink",
			"sessionTable": "QxFMzq_sessionTable",
			"status": "QxFMzq_status",
			"tableWrap": "QxFMzq_tableWrap",
			"token-analysis-spin": "QxFMzq_token-analysis-spin",
			"tokenValue": "QxFMzq_tokenValue",
			"trendControls": "QxFMzq_trendControls"
		};
		//#endregion
		...
		*/
		...
		const css = "._16eOsq_headerMetric,._16eOsq_sidebarMetric{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;white-space:nowrap;align-items:center;display:inline-flex}._16eOsq_headerMetric{border-left:1px solid var(--dsw-alias-border-l2);gap:5px;min-height:24px;margin-left:2px;padding-left:11px;font-size:11px;line-height:16px}._16eOsq_headerMetric strong,._16eOsq_sidebarMetric strong{color:var(--dsw-alias-label-primary);font-weight:600}._16eOsq_headerLabel{color:var(--dsw-alias-label-caption)}._16eOsq_unit{color:var(--dsw-alias-label-caption);font-size:10px}._16eOsq_signal{box-sizing:border-box;border:1px solid var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-base);border-radius:50%;flex:none;width:6px;height:6px;display:inline-block}[data-active]>._16eOsq_signal,[data-active] ._16eOsq_sidebarIcon ._16eOsq_signal{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-primary)}._16eOsq_sidebarMetric{box-sizing:border-box;background:var(--dsw-alias-bg-layer-2);border-radius:10px;gap:5px;width:100%;min-height:38px;padding:6px 8px 6px 7px;font-size:12px;line-height:18px;overflow:hidden}._16eOsq_sidebarIcon{width:20px;height:20px;color:var(--dsw-alias-label-secondary);flex:none;justify-content:center;align-items:center;display:inline-flex;position:relative}._16eOsq_sidebarIcon ._16eOsq_signal{border-color:var(--dsw-alias-bg-layer-2);background:var(--dsw-alias-label-caption);width:6px;height:6px;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2);position:absolute;bottom:0;right:-1px}._16eOsq_sidebarLabel{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._16eOsq_activeCount{min-width:0;color:var(--dsw-alias-label-caption);text-overflow:ellipsis;white-space:nowrap;margin-left:auto;font-size:10px;overflow:hidden}._16eOsq_sidebarMetric._16eOsq_rail{background:0 0;border-radius:50%;justify-content:center;width:36px;min-height:36px;padding:0}._16eOsq_sidebarMetric._16eOsq_rail:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}div:has(>[data-slot=\"sidebar.footer.action\"]>[data-token-throughput=all]){flex-direction:column;gap:4px}._16eOsq_rail ._16eOsq_sidebarIcon ._16eOsq_signal{border-color:var(--dsw-alias-bg-base);box-shadow:0 0 0 1px var(--dsw-alias-bg-base)}@media (width<=1100px){._16eOsq_headerLabel{clip:rect(0 0 0 0);width:1px;height:1px;position:absolute;overflow:hidden}}";
		...
		var TokenThroughput_module_css_default = {
			...
			"headerLabel": "_16eOsq_headerLabel",
			"headerMetric": "_16eOsq_headerMetric",
			"rail": "_16eOsq_rail",
			"sidebarIcon": "_16eOsq_sidebarIcon",
			"sidebarLabel": "_16eOsq_sidebarLabel",
			"sidebarMetric": "_16eOsq_sidebarMetric",
			"signal": "_16eOsq_signal",
			"unit": "_16eOsq_unit"
		};
		//#endregion
