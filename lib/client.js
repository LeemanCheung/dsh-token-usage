		...
		function ActivityHeatmap({ days, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					role: "grid",
					"aria-label": t("activity"),
					children: calendar.map((day) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", {
						role: "gridcell",
						"data-level": day.level,
						title: t("activityTooltip", {
							date: day.date,
							tokens: formatTokens(day.tokens)
						}),
						"aria-label": t("activityTooltip", {
							date: day.date,
							tokens: formatTokens(day.tokens)
						})
					}, day.date))
