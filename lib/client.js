window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function SafeMarkdownReport({ report, className, copyLabel, copiedLabel }) {
		...
		const css$1 = ".DKz7SW_section{width:100%;max-width:960px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:22px;display:flex}.DKz7SW_header{justify-content:space-between;align-items:flex-start;gap:16px;display:flex}.DKz7SW_header h2,.DKz7SW_header p,.DKz7SW_block h3,.DKz7SW_status{margin:0}.DKz7SW_header h2{font-size:18px;font-weight:600;line-height:26px}.DKz7SW_header p{max-width:720px;color:var(--dsw-alias-label-tertiary);margin-top:5px;font-size:13px;line-height:20px}.DKz7SW_metrics{grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;display:grid}.DKz7SW_metric{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:7px;min-width:0;padding:13px 14px;display:flex}.DKz7SW_metric span{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:16px;overflow:hidden}.DKz7SW_metric strong{font-variant-numeric:tabular-nums;text-overflow:ellipsis;font-size:20px;line-height:26px;overflow:hidden}.DKz7SW_activity{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:10px;min-width:0;padding:14px;display:flex}.DKz7SW_activityHead{justify-content:space-between;align-items:flex-end;gap:14px;display:flex}.DKz7SW_activityHead h3,.DKz7SW_activityHead p{margin:0}.DKz7SW_activityHead h3{font-size:14px;font-weight:600;line-height:22px}.DKz7SW_activityHead p{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:11px;line-height:17px}.DKz7SW_activityGrid{box-sizing:border-box;grid-template-rows:repeat(7,minmax(0,1fr));grid-template-columns:repeat(30,minmax(0,1fr));grid-auto-flow:column;gap:3px;width:100%;min-width:0;padding:2px;display:grid}.DKz7SW_activityCell,.DKz7SW_activityLegend i{background:var(--dsw-alias-bg-module-platform);border:0;border-radius:2px;flex:none;display:block}.DKz7SW_activityCell{aspect-ratio:1;cursor:pointer;width:100%;min-width:0;padding:0}.DKz7SW_activityCell:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.DKz7SW_activityCell[data-selected=true]{box-shadow:0 0 0 2px var(--dsw-alias-label-primary)}.DKz7SW_activityLegend i{width:10px;height:10px}.DKz7SW_activityCell[data-future=true]{cursor:default;background:0 0}.DKz7SW_activityCell[data-level=\"1\"],.DKz7SW_activityLegend i[data-level=\"1\"]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 22%, var(--dsw-alias-bg-module-platform))}.DKz7SW_activityCell[data-level=\"2\"],.DKz7SW_activityLegend i[data-level=\"2\"]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 42%, var(--dsw-alias-bg-module-platform))}.DKz7SW_activityCell[data-level=\"3\"],.DKz7SW_activityLegend i[data-level=\"3\"]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 64%, var(--dsw-alias-bg-module-platform))}.DKz7SW_activityCell[data-level=\"4\"],.DKz7SW_activityLegend i[data-level=\"4\"]{background:var(--dsw-alias-state-business-primary)}.DKz7SW_activityLegend{color:var(--dsw-alias-label-tertiary);white-space:nowrap;align-items:center;gap:4px;font-size:10px;line-height:14px;display:flex}.DKz7SW_insights,.DKz7SW_budget,.DKz7SW_dayDrilldown{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:12px;min-width:0;padding:14px;display:flex}.DKz7SW_insights h3,.DKz7SW_budget h3,.DKz7SW_dayDrilldown h3,.DKz7SW_insights p,.DKz7SW_budget p,.DKz7SW_dayDrilldown p{margin:0}.DKz7SW_insights h3,.DKz7SW_budget h3,.DKz7SW_dayDrilldown h3{font-size:14px;font-weight:600;line-height:22px}.DKz7SW_insights .DKz7SW_blockHead p,.DKz7SW_budget .DKz7SW_blockHead p,.DKz7SW_dayDrilldown .DKz7SW_blockHead p{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:11px;line-height:17px}.DKz7SW_detailMetrics{grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;display:grid}.DKz7SW_trendControls,.DKz7SW_rangeTabs,.DKz7SW_exportControls{flex-wrap:wrap;align-items:center;gap:6px;display:flex}.DKz7SW_trendControls{justify-content:flex-end}.DKz7SW_rangeTabs button,.DKz7SW_exportControls button,.DKz7SW_quietButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:30px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:7px;padding:0 9px;font-size:11px}.DKz7SW_rangeTabs button[aria-pressed=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, var(--dsw-alias-bg-layer-1));color:var(--dsw-alias-state-business-primary)}.DKz7SW_rangeTabs button:focus-visible,.DKz7SW_exportControls button:focus-visible,.DKz7SW_quietButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.DKz7SW_exportControls{justify-content:flex-end}.DKz7SW_exportControls>span{color:var(--dsw-alias-label-tertiary);font-size:11px}.DKz7SW_exportControls>small{max-width:520px;color:var(--dsw-alias-label-tertiary);text-align:right;flex-basis:100%;font-size:10px;line-height:15px}.DKz7SW_exportControls button:disabled,.DKz7SW_quietButton:disabled{opacity:.5;cursor:not-allowed}.DKz7SW_insightNote{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.DKz7SW_anomalyNotice{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:10px;font-size:11px;line-height:17px;display:flex}.DKz7SW_anomalyNotice p{margin:0}.DKz7SW_budgetInput{color:var(--dsw-alias-label-tertiary);white-space:nowrap;align-items:center;gap:7px;font-size:11px;display:flex}.DKz7SW_budgetInput input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:128px;height:30px;color:var(--dsw-alias-label-primary);font:inherit;font-variant-numeric:tabular-nums;border-radius:7px;outline:none;padding:0 8px;font-size:12px}.DKz7SW_budgetInput input:focus-visible{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}.DKz7SW_budgetProgress{align-items:center;gap:10px;display:flex}.DKz7SW_budgetProgress progress{width:min(320px,55%);height:8px;accent-color:var(--dsw-alias-state-business-primary)}.DKz7SW_budgetProgress strong{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;font-size:12px}.DKz7SW_budgetWarning{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.DKz7SW_routeBudgets{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:10px;padding-top:12px;display:flex}.DKz7SW_routeBudgetHead{justify-content:space-between;align-items:flex-end;gap:14px;display:flex}.DKz7SW_routeBudgetHead h4,.DKz7SW_routeBudgetHead p{margin:0}.DKz7SW_routeBudgetHead h4{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.DKz7SW_routeBudgetHead p{max-width:560px;color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:11px;line-height:17px}.DKz7SW_routeBudgetEditor{grid-template-columns:minmax(160px,1fr) 132px auto;align-items:end;gap:7px;display:grid}.DKz7SW_routeBudgetEditor label{min-width:0;color:var(--dsw-alias-label-tertiary);flex-direction:column;gap:3px;font-size:10px;display:flex}.DKz7SW_routeBudgetEditor select,.DKz7SW_routeBudgetEditor input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-primary);font:inherit;border-radius:7px;padding:0 8px;font-size:11px}.DKz7SW_routeBudgetEditor select:focus-visible,.DKz7SW_routeBudgetEditor input:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.DKz7SW_routeBudgetList{flex-direction:column;display:flex}.DKz7SW_routeBudgetRow{border-top:1px solid var(--dsw-alias-border-l2);grid-template-columns:minmax(170px,.8fr) minmax(260px,1.6fr) auto;align-items:center;gap:12px;padding:10px 0;display:grid}.DKz7SW_routeBudgetRow:last-child{padding-bottom:0}.DKz7SW_routeBudgetIdentity{flex-direction:column;gap:2px;min-width:0;display:flex}.DKz7SW_routeBudgetIdentity>strong{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;overflow:hidden}.DKz7SW_routeBudgetStatus{color:var(--dsw-alias-label-secondary);font-size:10px;font-weight:600;line-height:15px}.DKz7SW_routeBudgetStatus[data-status=warning],.DKz7SW_routeBudgetStatus[data-status=forecast-exceeded]{color:var(--dsw-alias-state-business-primary)}.DKz7SW_routeBudgetStatus[data-status=exceeded]{color:var(--dsw-alias-state-error-primary)}.DKz7SW_routeBudgetStatus[data-status=unavailable]{color:var(--dsw-alias-label-tertiary)}.DKz7SW_routeBudgetUsage{flex-direction:column;gap:3px;min-width:0;display:flex}.DKz7SW_routeBudgetRow>.DKz7SW_quietButton{justify-self:end}.DKz7SW_contributors{flex-direction:column;gap:7px;display:flex}.DKz7SW_contributors>strong{color:var(--dsw-alias-label-secondary);font-size:12px}.DKz7SW_contributors ol{gap:5px;margin:0;padding:0;list-style:none;display:grid}.DKz7SW_contributors li{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:7px;justify-content:space-between;align-items:center;gap:12px;padding:7px 9px;font-size:12px;display:flex}.DKz7SW_contributors li>span{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.DKz7SW_block{flex-direction:column;gap:10px;min-width:0;display:flex}.DKz7SW_block h3{font-size:14px;font-weight:600;line-height:22px}.DKz7SW_blockHead{justify-content:space-between;align-items:center;gap:16px;display:flex}.DKz7SW_blockHead input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:min(280px,45%);height:34px;color:var(--dsw-alias-label-primary);font:inherit;border-radius:8px;outline:none;padding:0 11px;font-size:12px}.DKz7SW_blockHead input::placeholder{color:var(--dsw-alias-label-tertiary)}.DKz7SW_blockHead input:focus-visible{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}.DKz7SW_tableWrap{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;min-width:0;overflow:auto}.DKz7SW_tableWrap table{border-collapse:collapse;width:100%;min-width:0;font-size:12px;line-height:18px}.DKz7SW_tableWrap .DKz7SW_modelTable{table-layout:fixed;min-width:580px}.DKz7SW_tableWrap .DKz7SW_sessionTable{min-width:780px}.DKz7SW_modelTable th:first-child,.DKz7SW_modelTable td:first-child{width:30%}.DKz7SW_modelTable th:nth-child(2),.DKz7SW_modelTable td:nth-child(2){width:18%}.DKz7SW_tableWrap th,.DKz7SW_tableWrap td{border-bottom:1px solid var(--dsw-alias-border-l1);text-align:right;vertical-align:middle;white-space:nowrap;padding:10px 12px}.DKz7SW_tableWrap th{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-tertiary);font-size:11px;font-weight:500}.DKz7SW_tableWrap th:first-child,.DKz7SW_tableWrap td:first-child{text-align:left;max-width:270px}.DKz7SW_tableWrap tbody tr:last-child td{border-bottom:0}.DKz7SW_tableWrap tbody tr:hover td{background:var(--dsw-alias-interactive-bg-hover)}.DKz7SW_tableWrap td{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums}.DKz7SW_tableWrap td strong,.DKz7SW_tableWrap td span{text-overflow:ellipsis;max-width:260px;display:block;overflow:hidden}.DKz7SW_tableWrap td strong{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600}.DKz7SW_tableWrap td span{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}.DKz7SW_tableWrap td .DKz7SW_tokenValue{max-width:none;color:inherit;font-size:inherit;line-height:inherit;display:inline}.DKz7SW_tableWrap td .DKz7SW_cacheDetail{margin-top:2px}.DKz7SW_analysisEmpty,.DKz7SW_analysisError,.DKz7SW_analysisPanel{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;gap:12px;min-width:0;padding:14px;display:flex}.DKz7SW_analysisEmpty{border-style:dashed}.DKz7SW_analysisError{border-color:var(--dsw-alias-state-error-primary)}.DKz7SW_analysisEmpty h3,.DKz7SW_analysisEmpty p,.DKz7SW_analysisError h3,.DKz7SW_analysisError p,.DKz7SW_analysisPanel h3,.DKz7SW_analysisPanel p{margin:0}.DKz7SW_analysisEmpty h3,.DKz7SW_analysisError h3,.DKz7SW_analysisPanel h3{font-size:14px;font-weight:600;line-height:22px}.DKz7SW_analysisEmpty p,.DKz7SW_analysisError p,.DKz7SW_analysisPanel .DKz7SW_blockHead p,.DKz7SW_analysisPrivacy{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:18px}.DKz7SW_analysisError p,.DKz7SW_analysisWarning{color:var(--dsw-alias-state-error-primary)}.DKz7SW_analysisCost{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);white-space:nowrap;border-radius:999px;padding:5px 9px;font-size:11px}.DKz7SW_analysisReport{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-module-platform);max-height:640px;color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere;border-radius:10px;margin:0;padding:18px 20px;font-size:13px;line-height:1.75;overflow:auto}.DKz7SW_analysisReport h1,.DKz7SW_analysisReport h2,.DKz7SW_analysisReport h3,.DKz7SW_analysisReport h4{color:var(--dsw-alias-label-primary);margin:1.25em 0 .55em;line-height:1.35}.DKz7SW_analysisReport h1:first-child,.DKz7SW_analysisReport h2:first-child,.DKz7SW_analysisReport h3:first-child,.DKz7SW_analysisReport p:first-child{margin-top:0}.DKz7SW_analysisReport p,.DKz7SW_analysisReport ul,.DKz7SW_analysisReport ol,.DKz7SW_analysisReport blockquote,.DKz7SW_analysisReport table{margin:.65em 0}.DKz7SW_analysisReport blockquote{border-left:3px solid var(--dsw-alias-state-business-primary);color:var(--dsw-alias-label-tertiary);padding-left:12px}.DKz7SW_analysisReport table{border-collapse:collapse;width:100%;font-size:12px}.DKz7SW_analysisReport th,.DKz7SW_analysisReport td{border:1px solid var(--dsw-alias-border-l2);text-align:left;vertical-align:top;padding:7px 9px}.DKz7SW_analysisReport th{background:var(--dsw-alias-bg-layer-3);color:var(--dsw-alias-label-primary)}.DKz7SW_analysisReport code{background:var(--dsw-alias-bg-layer-3);border-radius:4px;padding:1px 4px;font-family:ui-monospace,SFMono-Regular,Consolas,monospace;font-size:.92em}.DKz7SW_analysisHeaderActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;display:flex}.DKz7SW_analysisSummaryGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:9px;display:grid}.DKz7SW_analysisSummaryGroup{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);border-radius:9px;min-width:0;padding:10px 12px}.DKz7SW_analysisSummaryGroup h4{color:var(--dsw-alias-label-primary);margin:0 0 6px;font-size:12px;line-height:18px}.DKz7SW_analysisSummaryGroup dl{gap:4px;margin:0;display:grid}.DKz7SW_analysisSummaryGroup dl>div{justify-content:space-between;align-items:baseline;gap:10px;display:flex}.DKz7SW_analysisSummaryGroup dt{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;overflow:hidden}.DKz7SW_analysisSummaryGroup dd{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;white-space:nowrap;margin:0;font-size:12px;font-weight:600}.DKz7SW_analysisLoading{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;align-items:flex-start;gap:12px;padding:14px;display:flex}.DKz7SW_analysisSpinner{border:2px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:18px;height:18px;margin-top:2px;animation:.85s linear infinite DKz7SW_token-analysis-spin}.DKz7SW_analysisLoadingBody{flex:1;gap:6px;min-width:0;display:grid}.DKz7SW_analysisLoadingBody h3,.DKz7SW_analysisLoadingBody p{margin:0}.DKz7SW_analysisLoadingBody h3{color:var(--dsw-alias-label-primary);font-size:14px}.DKz7SW_analysisLoadingBody p,.DKz7SW_analysisProgressMeta{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.DKz7SW_analysisProgressMeta{flex-wrap:wrap;gap:10px;display:flex}.DKz7SW_analysisProgressMeta strong{color:var(--dsw-alias-state-business-primary)}.DKz7SW_analysisLoadingBody progress{width:100%;height:7px;accent-color:var(--dsw-alias-state-business-primary)}@keyframes DKz7SW_token-analysis-spin{to{transform:rotate(360deg)}}.DKz7SW_analysisWarning{font-size:11px;line-height:18px}.DKz7SW_modelSort{color:var(--dsw-alias-label-tertiary);align-items:center;gap:6px;font-size:11px;display:flex}.DKz7SW_modelSort select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:116px;color:var(--dsw-alias-label-primary);font:inherit;border-radius:7px;padding:5px 7px;font-size:12px}.DKz7SW_modelSort select:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.DKz7SW_sessionLink{max-width:240px;color:var(--dsw-alias-label-primary);font:inherit;text-align:left;text-overflow:ellipsis;white-space:nowrap;cursor:pointer;background:0 0;border:0;padding:0;font-weight:600;text-decoration:underline #0000;display:block;overflow:hidden}.DKz7SW_sessionLink:hover{text-decoration-color:currentColor}.DKz7SW_sessionLink:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;border-radius:2px}.DKz7SW_analysisButton{border:1px solid var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, var(--dsw-alias-bg-layer-1));min-height:28px;color:var(--dsw-alias-state-business-primary);font:inherit;cursor:pointer;border-radius:7px;padding:0 9px;font-size:11px}.DKz7SW_analysisButton:disabled{cursor:wait;opacity:.65}.DKz7SW_analysisButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.DKz7SW_pricingNotice{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3);color:var(--dsw-alias-label-tertiary);border-radius:10px;align-items:baseline;gap:8px;padding:10px 12px;font-size:11px;line-height:18px;display:flex}.DKz7SW_pricingNotice strong{color:var(--dsw-alias-label-secondary);white-space:nowrap;font-weight:600}.DKz7SW_pricingNotice p{margin:0}.DKz7SW_priceUnknown{color:var(--dsw-alias-label-tertiary)}.DKz7SW_priceValue{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;white-space:nowrap}.DKz7SW_analysisModelSelect{min-width:180px;color:var(--dsw-alias-label-tertiary);gap:4px;font-size:11px;line-height:16px;display:grid}.DKz7SW_analysisModelSelect select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-width:0;color:var(--dsw-alias-label-primary);font:inherit;border-radius:7px;padding:5px 7px;font-size:12px}.DKz7SW_analysisModelSelect select:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.DKz7SW_analysisScope{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:18px}.DKz7SW_analysisErrorText{color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:18px}.DKz7SW_conversationAnalysisButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);height:28px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:7px;padding:0 9px;font-size:11px}.DKz7SW_conversationAnalysisButton:hover{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}.DKz7SW_conversationAnalysisButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.DKz7SW_analysisDialog{width:min(820px,100%);max-height:min(84dvh,780px)}.DKz7SW_analysisDialogContent{overscroll-behavior:contain;min-height:0;overflow-y:auto}.DKz7SW_analysisDialog .DKz7SW_analysisReport{max-height:min(48dvh,460px)}.DKz7SW_conversationAnalysisControls{flex-wrap:wrap;align-items:end;gap:10px;margin-bottom:12px;display:flex}.DKz7SW_analysisHistory{border-top:1px solid var(--dsw-alias-border-l1);gap:9px;margin-top:16px;padding-top:14px;display:grid}.DKz7SW_analysisHistory h3,.DKz7SW_analysisHistory p{margin:0}.DKz7SW_analysisHistory .DKz7SW_blockHead>span{color:var(--dsw-alias-label-tertiary);font-size:11px}.DKz7SW_analysisHistory ul{gap:6px;max-height:210px;margin:0;padding:0;list-style:none;display:grid;overflow:auto}.DKz7SW_analysisHistory li{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);border-radius:8px;align-items:stretch;display:flex}.DKz7SW_analysisHistory li>button:first-child{min-width:0;color:var(--dsw-alias-label-secondary);text-align:left;cursor:pointer;background:0 0;border:0;flex:1;justify-content:space-between;align-items:center;gap:10px;padding:8px 10px;display:flex}.DKz7SW_analysisHistory li>button:first-child:hover{background:var(--dsw-alias-interactive-bg-hover)}.DKz7SW_analysisHistory li strong{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;overflow:hidden}.DKz7SW_analysisHistory li span{color:var(--dsw-alias-label-tertiary);white-space:nowrap;font-size:10px}.DKz7SW_historyDeleteButton{border:0;border-left:1px solid var(--dsw-alias-border-l1);width:34px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;font-size:18px}.DKz7SW_historyDeleteButton:hover{color:var(--dsw-alias-state-error-primary)}.DKz7SW_status{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-tertiary);border-radius:10px;padding:16px;font-size:13px;line-height:20px}@media (prefers-reduced-motion:reduce){.DKz7SW_analysisSpinner{animation:none}}@media (width<=860px){.DKz7SW_metrics{grid-template-columns:repeat(3,minmax(0,1fr))}.DKz7SW_detailMetrics,.DKz7SW_analysisSummaryGrid{grid-template-columns:repeat(2,minmax(0,1fr))}.DKz7SW_routeBudgetHead{flex-direction:column;align-items:stretch}.DKz7SW_routeBudgetRow{grid-template-columns:minmax(160px,.8fr) minmax(240px,1.4fr) auto}}@media (width<=580px){.DKz7SW_metrics,.DKz7SW_detailMetrics{grid-template-columns:repeat(2,minmax(0,1fr))}.DKz7SW_analysisSummaryGrid{grid-template-columns:minmax(0,1fr)}.DKz7SW_header,.DKz7SW_activityHead,.DKz7SW_blockHead{flex-direction:column;align-items:stretch;gap:8px}.DKz7SW_exportControls{justify-content:flex-start}.DKz7SW_exportControls>small{text-align:left}.DKz7SW_routeBudgetEditor,.DKz7SW_routeBudgetRow{grid-template-columns:minmax(0,1fr)}.DKz7SW_routeBudgetRow{gap:8px}.DKz7SW_routeBudgetRow>.DKz7SW_quietButton{justify-self:start}.DKz7SW_budgetInput{justify-content:space-between}.DKz7SW_pricingNotice{flex-direction:column;align-items:flex-start;gap:2px}.DKz7SW_budgetProgress{flex-direction:column;align-items:flex-start}.DKz7SW_budgetProgress progress,.DKz7SW_blockHead input{width:100%}}";
		...
		var TokenUsageSection_module_css_default = {
			"activity": "DKz7SW_activity",
			"activityCell": "DKz7SW_activityCell",
			"activityGrid": "DKz7SW_activityGrid",
			"activityHead": "DKz7SW_activityHead",
			"activityLegend": "DKz7SW_activityLegend",
			"analysisButton": "DKz7SW_analysisButton",
			"analysisCost": "DKz7SW_analysisCost",
			"analysisDialog": "DKz7SW_analysisDialog",
			"analysisDialogContent": "DKz7SW_analysisDialogContent",
			"analysisEmpty": "DKz7SW_analysisEmpty",
			"analysisError": "DKz7SW_analysisError",
			"analysisErrorText": "DKz7SW_analysisErrorText",
			"analysisHeaderActions": "DKz7SW_analysisHeaderActions",
			"analysisHistory": "DKz7SW_analysisHistory",
			"analysisLoading": "DKz7SW_analysisLoading",
			"analysisLoadingBody": "DKz7SW_analysisLoadingBody",
			"analysisModelSelect": "DKz7SW_analysisModelSelect",
			"analysisPanel": "DKz7SW_analysisPanel",
			"analysisPrivacy": "DKz7SW_analysisPrivacy",
			"analysisProgressMeta": "DKz7SW_analysisProgressMeta",
			"analysisReport": "DKz7SW_analysisReport",
			"analysisScope": "DKz7SW_analysisScope",
			"analysisSpinner": "DKz7SW_analysisSpinner",
			"analysisSummaryGrid": "DKz7SW_analysisSummaryGrid",
			"analysisSummaryGroup": "DKz7SW_analysisSummaryGroup",
			"analysisWarning": "DKz7SW_analysisWarning",
			"anomalyNotice": "DKz7SW_anomalyNotice",
			"block": "DKz7SW_block",
			"blockHead": "DKz7SW_blockHead",
			"budget": "DKz7SW_budget",
			"budgetInput": "DKz7SW_budgetInput",
			"budgetProgress": "DKz7SW_budgetProgress",
			"budgetWarning": "DKz7SW_budgetWarning",
			"cacheDetail": "DKz7SW_cacheDetail",
			"contributors": "DKz7SW_contributors",
			"conversationAnalysisButton": "DKz7SW_conversationAnalysisButton",
			"conversationAnalysisControls": "DKz7SW_conversationAnalysisControls",
			"dayDrilldown": "DKz7SW_dayDrilldown",
			"detailMetrics": "DKz7SW_detailMetrics",
			"exportControls": "DKz7SW_exportControls",
			"header": "DKz7SW_header",
			"historyDeleteButton": "DKz7SW_historyDeleteButton",
			"insightNote": "DKz7SW_insightNote",
			"insights": "DKz7SW_insights",
			"metric": "DKz7SW_metric",
			"metrics": "DKz7SW_metrics",
			"modelSort": "DKz7SW_modelSort",
			"modelTable": "DKz7SW_modelTable",
			"priceUnknown": "DKz7SW_priceUnknown",
			"priceValue": "DKz7SW_priceValue",
			"pricingNotice": "DKz7SW_pricingNotice",
			"quietButton": "DKz7SW_quietButton",
			"rangeTabs": "DKz7SW_rangeTabs",
			"routeBudgetEditor": "DKz7SW_routeBudgetEditor",
			"routeBudgetHead": "DKz7SW_routeBudgetHead",
			"routeBudgetIdentity": "DKz7SW_routeBudgetIdentity",
			"routeBudgetList": "DKz7SW_routeBudgetList",
			"routeBudgetRow": "DKz7SW_routeBudgetRow",
			"routeBudgetStatus": "DKz7SW_routeBudgetStatus",
			"routeBudgetUsage": "DKz7SW_routeBudgetUsage",
			"routeBudgets": "DKz7SW_routeBudgets",
			"section": "DKz7SW_section",
			"sessionLink": "DKz7SW_sessionLink",
			"sessionTable": "DKz7SW_sessionTable",
			"status": "DKz7SW_status",
			"tableWrap": "DKz7SW_tableWrap",
			"token-analysis-spin": "DKz7SW_token-analysis-spin",
			"tokenValue": "DKz7SW_tokenValue",
			"trendControls": "DKz7SW_trendControls"
		};
		//#endregion
		...
		*/
		var TokenThroughputController = class {
			...
			*/
			...
			sample(at = performance.now()) {
				...
				const missingCounters = /* @__PURE__ */ new Set();
				...
				this.snapshot = Object.freeze({
					status: state.phase !== "ready" || missingCounters.size > 0 ? "sampling" : current.size === 0 ? hasPriorSample ? "ready" : "sampling" : ready && everyCurrentReady ? "ready" : "sampling",
		...
		const css = ".q_YqcG_headerMetric,.q_YqcG_sidebarMetric{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;white-space:nowrap;align-items:center;display:inline-flex}.q_YqcG_headerMetric{border-left:1px solid var(--dsw-alias-border-l2);gap:5px;min-height:24px;margin-left:2px;padding-left:11px;font-size:11px;line-height:16px}.q_YqcG_headerMetric strong,.q_YqcG_sidebarMetric strong{color:var(--dsw-alias-label-primary);font-weight:600}.q_YqcG_headerLabel{color:var(--dsw-alias-label-caption)}.q_YqcG_unit{color:var(--dsw-alias-label-caption);font-size:10px}.q_YqcG_signal{box-sizing:border-box;border:1px solid var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-base);border-radius:50%;flex:none;width:6px;height:6px;display:inline-block}[data-active]>.q_YqcG_signal,[data-active] .q_YqcG_sidebarIcon .q_YqcG_signal{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-primary)}.q_YqcG_sidebarMetric{box-sizing:border-box;background:var(--dsw-alias-bg-layer-2);border-radius:10px;gap:5px;width:100%;min-height:38px;padding:6px 8px 6px 7px;font-size:12px;line-height:18px;overflow:hidden}.q_YqcG_sidebarIcon{width:20px;height:20px;color:var(--dsw-alias-label-secondary);flex:none;justify-content:center;align-items:center;display:inline-flex;position:relative}.q_YqcG_sidebarIcon .q_YqcG_signal{border-color:var(--dsw-alias-bg-layer-2);background:var(--dsw-alias-label-caption);width:6px;height:6px;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2);position:absolute;bottom:0;right:-1px}.q_YqcG_sidebarLabel{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.q_YqcG_activeCount{min-width:0;color:var(--dsw-alias-label-caption);text-overflow:ellipsis;white-space:nowrap;margin-left:auto;font-size:10px;overflow:hidden}.q_YqcG_sidebarMetric.q_YqcG_rail{background:0 0;border-radius:50%;justify-content:center;width:36px;min-height:36px;padding:0}.q_YqcG_sidebarMetric.q_YqcG_rail:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}div:has(>[data-slot=\"sidebar.footer.action\"]>[data-token-throughput=all]){flex-direction:column;gap:4px}.q_YqcG_rail .q_YqcG_sidebarIcon .q_YqcG_signal{border-color:var(--dsw-alias-bg-base);box-shadow:0 0 0 1px var(--dsw-alias-bg-base)}@media (width<=1100px){.q_YqcG_headerLabel{clip:rect(0 0 0 0);width:1px;height:1px;position:absolute;overflow:hidden}}";
		...
		var TokenThroughput_module_css_default = {
			"activeCount": "q_YqcG_activeCount",
			"headerLabel": "q_YqcG_headerLabel",
			"headerMetric": "q_YqcG_headerMetric",
			"rail": "q_YqcG_rail",
			"sidebarIcon": "q_YqcG_sidebarIcon",
			"sidebarLabel": "q_YqcG_sidebarLabel",
			"sidebarMetric": "q_YqcG_sidebarMetric",
			"signal": "q_YqcG_signal",
			"unit": "q_YqcG_unit"
		};
		//#endregion
