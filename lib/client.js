window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function usageEfficiencyInsight(usage, compactionUsage, models) {
		...
		*/
		...
		function BudgetPanel({ days, snapshot, setBudget, t }) {
			const insight = (0, react.useMemo)(() => periodInsight(days, 30), [days]);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					snapshot.status !== "ready" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						ratio <= 1 && runRate.projectedThirtyDayTokens > budget ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: TokenUsageSection_module_css_default.budgetWarning,
		...
		function EfficiencyPanel({ usage, compactionUsage, models, t }) {
			const insight = (0, react.useMemo)(() => usageEfficiencyInsight(usage, compactionUsage, models), [
				usage,
				compactionUsage,
				models
			]);
		...
		function OperationsPanel({ days, onSelectDate, t }) {
			const runRate = (0, react.useMemo)(() => runRateInsight(days), [days]);
			const anomaly = (0, react.useMemo)(() => dailyAnomalyInsight(days), [days]);
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: TokenUsageSection_module_css_default.insights,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Metric, {
								...
								value: Math.round(runRate.averageDailyTokens)
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Metric, {
								label: t("projectedThirtyDayUsage"),
								value: runRate.projectedThirtyDayTokens
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Metric, {
		...
		function TokenUsageSection({ close, useSessions, useBudget, setBudget, download, openSession, listAnalysisModels, analyzeTokenUsage, analyzeTrajectory, t }) {
			...
			const priceCoverage = costSummary.totalTokens === 0 ? 0 : Math.round(costSummary.coveredTokens / costSummary.totalTokens * 100);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("pricingTitle") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: t("pricingIntro", {
